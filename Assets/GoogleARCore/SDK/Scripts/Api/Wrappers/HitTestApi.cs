...
namespace GoogleARCoreInternal
{
    ...
    internal class HitTestApi
    {
        ...
        /// <summary>
        /// Функция обновляет лист попаданий при помощи сэссии (её контролирует session config)
        /// </summary>
            ...
            List<TrackableHit> outHitList)
        {
            ...
            ExternApi.ArHitResultList_create(m_NativeSession.SessionHandle, ref hitResultListHandle);  //берут из ARCoreNativeApi
